...
fun Account.asDatabaseAccount()  : com.nima.tmdb.framewrok.datasource.cache.entities.Account {
    return com.nima.tmdb.framewrok.datasource.cache.entities.Account(
        id = this.id!!,
